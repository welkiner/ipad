...
- (IBAction)nextBtnClick:(id)sender {
    self.model.question6 = [NSString stringWithFormat:@"%@%@%@%@",[self answerStr],[self answerStr2],[self answerStr3],[self answerStr4]];
    if (self.model.question6.length < 4) {
