...
+(instancetype)controllerWithModel2:(UserModel2 *)model{
    QuestionBaseController *con = [[UIStoryboard storyboardWithName:@"2" bundle:nil] instantiateViewControllerWithIdentifier:NSStringFromClass(self)];
    con.model2 = model;
    return con;
}
- (void)viewDidLoad {
...
static NSDictionary *__dic(){
    return @{@"100":@"A",@"101":@"B",@"102":@"C",@"103":@"D"};
}
-(NSString *)answerStr{
